...
# Patch pour textual.containers.VerticalGroup
print("Creating mock for textual.containers.VerticalGroup")
import types
...
# Patch pour textual.app
if 'textual.app' not in sys.modules:
    print("Creating mock for textual.app")
    ...
    class MockComposeResult:
        def __init__(self, *args, **kwargs):
            pass
    
    sys.modules['textual.app'].App = MockApp
    sys.modules['textual.app'].ComposeResult = MockComposeResult

# Patch pour textual.widgets
if 'textual.widgets' not in sys.modules:
    print("Creating mock for textual.widgets")
    sys.modules['textual.widgets'] = types.ModuleType('textual.widgets')
    ...
    sys.modules['textual.widgets'].Label = MockLabel
    sys.modules['textual.widgets'].Select = MockSelect
