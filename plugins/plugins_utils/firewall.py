...
class FirewallCommands(PluginUtilsBase):
    ...
    def get_status(self, numbered: bool = True) -> Optional[str]:
        """
    ...
    def set_default_policy(self, policy: str, direction: str = 'incoming') -> bool:
        """
